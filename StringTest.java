...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// equalsIgnoreCase() : 값을 비교해 준다.(대소문자를 구별하지 않는다.)
		...
		System.out.println("charAt()->" + addr.charAt(5));//index위의 문자를 반환한다.
		...
		//없는 문자일때 -1
		int idx = addr.indexOf("강남"); // 서울시 강남구 강남구 역삼동(DONG)홍길동
		...
		System.out.println("data->" + data.trim()+"?");//양 사이드에 있는 공백이 안 찍힌다.
	}
